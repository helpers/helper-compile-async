# Contributing to helper-compile-async

First and foremost, thank you! We appreciate that you want to contribute to helper-compile-async, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for helper-compile-async**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for helper-compile-async:

- star the [project](https://github.com/helpers/helper-compile-async)
- tweet your support for helper-compile-async
...
- **version**: please note the version of helper-compile-async are you using
...
[so]: http://stackoverflow.com/questions/tagged/helper-compile-async